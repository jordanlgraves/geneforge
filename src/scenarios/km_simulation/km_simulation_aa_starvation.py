...
In E. coli K-12 MG1655 growing at 37 °C, pH 7.0, uncharged tRNA binds the ribosomal A-site and activates the ribosome-bound synthetase RelA. 
Activated RelA synthesises ppGpp from GTP and ATP with a reported kcat ≈ 110 s⁻¹ and Km(GTP) ≈ 0.15 mM.
The bifunctional enzyme SpoT hydrolyses ppGpp to GDP (ppGpp + H₂O → GDP + PPi) with kcat ≈ 4 s⁻¹, Km(ppGpp) ≈ 18 µM. 
SpoT can also synthesise ppGpp at a lower rate (kcat ≈ 1 s⁻¹).
...
class KMAminoAcidStarvationScenario(Scenario):
